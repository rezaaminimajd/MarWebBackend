...
class UserReactionTemplate(models.Model):
...
class Post(UserReactionTemplate):
...
class Comment(UserReactionTemplate):
...
class Like(models.Model):
    from ..account.models import Profile
    target = models.ForeignKey(UserReactionTemplate, related_name='likes', on_delete=models.CASCADE)
